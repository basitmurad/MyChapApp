...
import com.example.mychapapp.databinding.ItemstatusBinding;
...
public class UserStatusAdapter extends RecyclerView.Adapter<UserStatusAdapter.TopStatusViewHolder> {

    Context context;
    private ArrayList<UserStatus> userStatuses;

    public UserStatusAdapter(Context context, ArrayList<UserStatus> userStatuses) {
    ...
    public void onBindViewHolder(@NonNull TopStatusViewHolder holder, int position) {
        ...
        Glide.with(context).load( lastStatus.getImageUrl()).into(holder.binding.image23);
        holder.binding.circularStatusView.setPortionsCount(userStatus.getStatuses().size());
           ...
           holder.binding.circularStatusView.setOnClickListener(new View.OnClickListener() {
               ...
               public void onClick(View view) {
                   ...
                   new StoryView.Builder(((DashBoardActivity)context).getSupportFragmentManager())
       ...
       {
           Log.d("array",exception.getLocalizedMessage());
       }
       finally {
